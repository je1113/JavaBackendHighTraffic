...
- [x] **7.1.2.1** 포트와 어댑터 구조 검증 (1시간 30분)
- [x] **7.1.2.2** 도메인 로직 격리 검증 (1시간 30분)

### 🔬 7.2 단위 테스트 (8시간)

#### 7.2.1 Domain Layer 테스트 (4시간)
- [x] **7.2.1.1** Aggregate 테스트 (2시간)
- [x] **7.2.1.2** Domain Service 테스트 (2시간)

#### 7.2.2 Application Layer 테스트 (4시간)
- [x] **7.2.2.1** Use Case 테스트 (2시간)
- [x] **7.2.2.2** Event Handler 테스트 (2시간)
