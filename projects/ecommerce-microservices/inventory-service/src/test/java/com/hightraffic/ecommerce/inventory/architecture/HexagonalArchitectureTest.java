...
class HexagonalArchitectureTest {
    ...
    private static final String PORT_IN_PACKAGE = "com.hightraffic.ecommerce.inventory.application.port.in..";
    private static final String PORT_OUT_PACKAGE = "com.hightraffic.ecommerce.inventory.application.port.out..";
    ...
    void outboundAdaptersShouldImplementOutboundPorts() {
        ArchRule rule = classes()
                ...
                .and().areNotEnums()
                .should().implement(
                        "com.hightraffic.ecommerce.inventory.application.port.out.LoadProductPort"
                ).orShould().implement(
                        "com.hightraffic.ecommerce.inventory.application.port.out.SaveProductPort"
                ).orShould().implement(
                        "com.hightraffic.ecommerce.inventory.application.port.out.PublishEventPort"
                ).orShould().implement(
                        "com.hightraffic.ecommerce.inventory.application.port.out.CachePort"
                ).orShould().implement(
                        "com.hightraffic.ecommerce.inventory.application.port.out.DistributedLockPort"
                ).orShould().implement(
                        "com.hightraffic.ecommerce.inventory.application.port.out.LoadProductsByConditionPort"
                ).orShould().implement(
                        "com.hightraffic.ecommerce.inventory.application.port.out.InventoryPersistencePort"
                )
    ...
    void applicationServicesShouldImplementInboundPorts() {
        ArchRule rule = classes()
                ...
                .should().implement(
                        "com.hightraffic.ecommerce.inventory.application.port.in.GetStockUseCase"
                ).orShould().implement(
                        "com.hightraffic.ecommerce.inventory.application.port.in.ReserveStockUseCase"
                ).orShould().implement(
                        "com.hightraffic.ecommerce.inventory.application.port.in.DeductStockUseCase"
                ).orShould().implement(
                        "com.hightraffic.ecommerce.inventory.application.port.in.RestoreStockUseCase"
                )
    ...
    void applicationHandlersShouldImplementInboundPorts() {
        ArchRule rule = classes()
                ...
                .should().implement(
                        "com.hightraffic.ecommerce.inventory.application.port.in.HandleOrderCreatedEventUseCase"
                ).orShould().implement(
                        "com.hightraffic.ecommerce.inventory.application.port.in.HandleOrderCancelledEventUseCase"
                )
                .because("애플리케이션 핸들러는 인바운드 포트(UseCase)를 구현해야 합니다");
    ...
    void eventHandlersShouldOnlyCallApplicationServices() {
        ArchRule rule = classes()
                ...
                .resideInAnyPackage(
                        "com.hightraffic.ecommerce.inventory.application.port.in..",
                        "com.hightraffic.ecommerce.inventory.adapter.in.messaging..",
    ...
    void configurationClassesShouldBeInConfigPackage() {
        ArchRule rule = classes()
                ...
                .because("설정 클래스는 config 패키지에 위치해야 합니다");
